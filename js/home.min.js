...
function applySoundState() {
  ...
  if (soundImage?.dataset) {
    soundImage.src = isSoundEnabled ? (soundImage.dataset.imageOn || soundImage.src)
...
(function initSound() {
  ...
  window.sound = sound;
  window.playSoundEffect = (name = "boop") => sound.play(name);

  // Apply current saved sound state
  applySoundState();
})();
