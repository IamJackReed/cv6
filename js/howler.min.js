...
(function initSound() {
  ...
  const bb8 = new Howl({
    src: ["images/bb8.webm", "images/bb8.mp3"], // add bb8.mp3 to /images/ for best coverage
    volume: 0.6,
    html5: false,           // try WebAudio first; set true if you see autoplay issues
    preload: true,
  ...
  // Apply saved sound state (mutes everything via Howler + the sprite howl)
  applySoundState();
})();
